        ...
        <table class="table">
            ...
            <?php foreach($users as $user): ?>
                ...
                <td><?php echo $user->first_name;?></td><td><?php echo $user->last_name;?></td>
                    ...
                    <td><a class="btn btn-warning rounded-0" href="edit_user.php?id=<?php echo $user->id;
                        ?>"><i class="far fa-edit"></i></a></td>
                    <?php if ($user->timestamp == NULL) : ?>
                        <td><a class="btn btn-danger rounded-0" href="soft_delete_user.php?id=<?php echo $user->id;
                            ?>"><i class="fas fa-eye"></i></a></td>
                    <?php else : ?>
                         <td><a class="btn btn-danger rounded-0" href="undelete_user.php?id=<?php echo $user->id;
